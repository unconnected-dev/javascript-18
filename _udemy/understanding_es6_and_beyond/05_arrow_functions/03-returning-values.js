...
// When there is only one expression after the arrow (=>), the result of that
// expression is returned automatically without needing an explicit return
// statement.
// This is called "implicit return" and is just syntactic sugar to make the 
// code more concise.
let add2 = (a, b) => a + b;
...
// If the arrow function takes only one parameter, the parentheses around the
...
// Note: You cannot declare a variable directly within the body of an arrow
