...
// - Static fields (or properties) and methods belong to the class itself, not
//   to instances of the class.
// - They are called on the class directly, rather than on instances of the 
//   class.
// - Static members are often used for utility functions, constants, or data 
//   that is shared across all instances of the class.
...
class Person{
    ...
    // - Like static fields, static methods are also associated with the class 
    //   itself.
...
// - Static fields are shared among all instances of the class, but they are
//   not tied to any specific instance.
// - These fields are accessed directly on the class itself, rather than on
//   the instances.

// Static Methods:
// - Similar to static fields, static methods are also defined using the 
//   static keyword.
// - These methods can be called directly on the class without needing to
//   create an instance.
...
// Use Cases:
// - Static fields are ideal for defining constants or shared data that is 
//   common to all instances.
// - Static methods are useful for utility functions or operations that are
//   related to the class but not tied to any particular instance.