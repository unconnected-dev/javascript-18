...
// - JavaScript classes are syntactic sugar over the prototype-based 
//   inheritance system that has always existed in the language.
// - Under the hood, a class in JavaScript is still just a special kind of 
//   function that sets up the prototype chain in a more intuitive way.
...
// - A special internal flag, `isClassConstructor`, is set to `true`, which 
//   differentiates class constructors from regular functions.
// - This flag helps ensure that class constructors cannot be called without
//   the `new` keyword, which would otherwise result in an error.
...
// Classes in JavaScript:
// - Classes are syntactic sugar for creating objects using the 
//   prototype-based inheritance model.

// Comparison to Other Languages:
// - Unlike in languages like C# or Java, where classes are central to creating
//   types, JavaScript classes are just another way to create objects.

// Classes as Functions:
// - Internally, a class in JavaScript is just a special kind of function. The
//   typeof operator returns "function" when applied to a class.

// Syntactic Sugar:
// - JavaScript classes don’t add new functionality; they simply provide a more 
//   intuitive and readable way to work with objects and inheritance.