...
//Infix notation is more readable and is the standard in most programming languages



//Operators as Functions
//Operators are essentially shorthand for built-in functions that perform specific 
//tasks. These "operator functions" are provided by the JavaScript engine and perform
...
//This is evaluated as y = z, then x = y, which means all variables end up with 
//the value of 4
if(false){
    x = y = z;
...
//  Because of right-to-left associativity, assignments cascade from right to left