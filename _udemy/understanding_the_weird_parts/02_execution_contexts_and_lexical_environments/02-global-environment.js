...
// The base execution context in JavaScript is the global execution context. It 
// is accessible everywhere in your code, and it is the first context that is 
// created when your script starts.

// The global execution context creates two key things:
// - A global object (`window` in browsers, or `global` in Node.js)
// - A special keyword, `this`, which refers to the global object in the global 
// context.

// These are automatically created by the JavaScript engine when the global 
...
// Variables and functions declared outside of other functions are automatically 
...
// global execution context does not have an outer environment, meaning there is 
// nothing above it. For functions, an execution context is created when they are 
// invoked.