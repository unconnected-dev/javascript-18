...
// person[dynamicKey]. It’s flexible and can handle property names with 
...
// Computed Member Access Operator
// You can create properties dynamically using bracket notation. This will 
// store the value at the specified memory address for the 'person' object.
...
// person['address']['city'] are evaluated from left to right and interpreted
// as below:
// 
//  ((person['address'])['city'])
//  ((person.address).city)